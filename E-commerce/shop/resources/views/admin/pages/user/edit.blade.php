...
@section('content')
         ...
         <div class="card">
           <div class="card-body">
           <div class="card-title">Edit User
           ...
           <div class="form-group col-md-6">
            ...
            <input value="{{$user->name}}" type="text" class="form-control" name="name" id="name" placeholder="Enter User's Name">
            <p></p>
           </div>
           ...
           <div class="form-group col-md-6">
            ...
            <input value="{{$user->email}}" type="text" class="form-control" name="email" id="email" placeholder="Enter User's Email">
            <p></p>
           </div>
           <div class="form-group col-md-6">
            <label for="phone">Phone</label>
            <input value="{{$user->phone}}" type="text" class="form-control" name="phone" id="phone" placeholder="Enter User's Phone">
            <p></p>
           </div>
