...
@section('content')
         ...
         <div class="card">
           <div class="card-body">
           <div class="card-title">Add Coupon Code
           ...
           <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" name="code" id="code" placeholder="Enter Coupon's Code">
            <p></p>
           </div>

           <div class="form-group col-md-6">
            <label for="name">Name</label>
            <input type="text" class="form-control" name="name" id="name" placeholder="Enter Coupon's Name">
            <p></p>
           </div>
           ...
           <div class="form-group col-md-3">
            ...
            <input type="number" class="form-control" name="max_uses" id="max_uses" placeholder="Enter Coupon's Max Uses">
            <p></p>
           </div>

           <div class="form-group col-md-3">
            <label for="max_uses_user">Max uses user</label>
            <input type="text" class="form-control" name="max_uses_user" id="max_uses_user" placeholder="Enter Coupon's Max Uses User">
            <p></p>
           </div>
           ...
           <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" name="discount_amount" id="discount_amount" placeholder="Enter Coupon's Discount Amount">
            <p></p>
           </div>

           <div class="form-group col-md-3">
            <label for="min_amount">Min Amount</label>
            <input type="text" class="form-control" name="min_amount" id="min_amount" placeholder="Enter Coupon's Min Amount">
            <p></p>
           </div>
           ...
           <div class="form-group col-md-3">
            ...
            <input autocomplete="off" type="text" class="form-control" name="start_at" id="start_at" placeholder="Enter Coupon's Start At">
            <p></p>
           </div>

           <div class="form-group col-md-3">
            <label for="expires_at">Expires at</label>
            <input autocomplete="off" type="text" class="form-control" name="expires_at" id="expires_at" placeholder="Enter Coupon's Expires At">
            <p></p>
           </div>

           <div class="form-group col-md-12">
            <label for="description">Description</label>
            <textarea name="description" id="description" class="summernote" placeholder="Description"  cols="30" rows="10" style="color:white;"></textarea>
            <p></p>
           </div>
