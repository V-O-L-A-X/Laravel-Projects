...
@section('content')
         ...
         <div class="card">
           ...
           <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="name" id="name" placeholder="Enter Brand's Name" value="{{$brand->name}}">
            <p></p>
           </div>
           <div class="form-group col-md-4">
            <label for="slug">Slug</label>
            <input type="text" class="form-control" name="slug" id="slug" placeholder="Slug" value="{{$brand->slug}}" readonly>
            <p></p>
           </div>
