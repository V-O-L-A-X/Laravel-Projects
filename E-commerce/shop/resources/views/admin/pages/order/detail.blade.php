    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="card-header pt-3">
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col">
                                ...
                                <b>Total:</b> {{number_format($order->grand_total,0,",",".")}} đ<br>
                                <b>Status:</b> 
            ...
            @include('admin.message')
                <div class="card">
                    <form action="" method="POST" name="changeOrderStatusF" id="changeOrderStatusF">
                    <div class="card-body">
...
$("#changeOrderStatusF").submit(function (event) 
{
    event.preventDefault();

    if(confirm("Are you sure you want to change order's status?"))
    {
