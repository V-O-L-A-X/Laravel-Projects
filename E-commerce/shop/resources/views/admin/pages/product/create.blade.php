                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="short_description" id="short_description" class="summernote" placeholder="Short Description"  cols="30" rows="10" style="color:white;"></textarea>
                                                </div>
                                            </div>   
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="shipping_returns" id="shipping_returns" class="summernote" placeholder="shipping_returns"  cols="30" rows="10" style="color:white;"></textarea>
                                                </div>
                                            </div>                                             
                                        </div>
                                    </div>	                                                                      
