...
<!-- Start wrapper-->
 ...
 <div class="loader-wrapper"><div class="lds-ring"><div></div><div></div><div></div><div></div></div></div>
		...
		<div class="card-body">
		 <div class="card-content p-2">
		 	<div class="text-center">
		 		<img src="adminstyle/assets/images/logo-icon.png" alt="logo icon">
		 	</div>
			...
			<div class="form-group">
			  <label for="email" class="sr-only">Email</label>
			   <div class="position-relative has-icon-right">
				  <input type="text" id="email" name="email" value="{{old('email')}}" class="form-control input-shadow" placeholder="Enter Email">
  ...
  <script src="adminstyle/assets/js/jquery.min.js"></script>
