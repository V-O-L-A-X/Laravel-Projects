                    ...
                    <div class="card cart-summery">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mt-2">
                                ...
                                <div class="h6"><strong id="shippingAmount">{{number_format($totalShippingCharge,2)}} đ</strong></div>
                            </div>
                            <div class="d-flex justify-content-between mt-2 summery-end">
                                <div class="h5"><strong>Total</strong></div>
                                <div class="h5"><strong id="grandTotal">{{number_format($grandTotal,2)}} đ</strong></div>
                            </div>                            
                        </div>
                    </div>   
