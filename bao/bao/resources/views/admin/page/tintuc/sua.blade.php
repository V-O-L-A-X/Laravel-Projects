                    ...
                    @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="theloai">
                                    ...
                                    <option value="{{$tl->id}}" @if($tintuc->loaitin->theloai->id==$tl->id)
                                        {{"selected"}}
                                        @endif > 
                                        {{$tl->Ten}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="loaitin">
                                    ...
                                    <option value="{{$lt->id}}" @if($tintuc->loaitin->id==$lt->id)
                                        {{"selected"}}
                                        @endif > 
                                        {{$lt->Ten}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                <label>Tóm Tắt</label>
                                <textarea name="tomtat" row="3" class="form-control ckeditor">
                                    {{$tintuc->TomTat}}</textarea>
                            </div>

                            <div class="form-group">
                                <label>Nội dung</label>
                                <textarea name="noidung" row="3" class="form-control ckeditor">
                                    {{$tintuc->NoiDung}}</textarea>
                            </div>

                            <div class="form-group">
                                <label>Hình ảnh</label>
                                <img src="images/{{$tintuc->Hinh}}" alt="Hình tin tức">
